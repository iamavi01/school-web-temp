  ...
  return (
    <>
      <h2 className="latest_heading">
        Latest<span className="latest_heading2"> News</span>
      </h2>
      <br />
      <br />
          ...
          return (
            <>
              <div className="latest_container">
                ...
                <br />
                <br />
                <div className="latest_post_date">
                  <span className="latest_logo">
                    <BsCalendar2Minus />{" "}
                  </span>
                  {val.date_top}
                </div>
                <div className="latest_container_title">{val.title}</div>
                <br />
